  ...
  return (
    <div className="flex justify-center flex-col md:flex-row h-auto   lg:pt-20">
      <div className="md:m-20 m-2">
        ...
        <div></div>
        <br />
        <span className="cursor-target text-white text-sm">
        ...
        {/* <span></span> */}
        <button className="cursor-target text-pink-400 mt-10 flex px-6 py-1 border">
        ...
        <a
          href="/meraj2.pdf"
          download
          className="cursor-target text-pink-400 mt-10 flex px-6 py-1 border"
        >
          Resume
        </a>
        </div>
      ...
      <div className="m-2">
        <motion.img
          ...
          className="cursor-target md:h-[386px] h-[300px]  cursor-pointer"
          src={Icon.main_hero}
          alt="Profile"
        />
